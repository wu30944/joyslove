                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" id="form_create" >
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_zh_company_name">@lang('default.zh_company_name'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_zh_company_name" name="create_zh_company_name" >
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_en_company_name">@lang('default.en_company_name'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_en_company_name" name="create_en_company_name" >
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_address">@lang('default.address'):</label>
                                <div class="col-sm-10">
                            ...
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_fex">@lang('default.fex'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_fex" name="create_fex">
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_telephone">@lang('default.telephone'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_telephone" name="create_telephone">
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_email">@lang('default.email'):</label>
                                <div class="col-sm-10">
                            ...
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_uniform_number">@lang('default.uniform_number'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_uniform_number" name="create_uniform_number">
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_zh_introduction">@lang('default.zh_introduction'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_zh_introduction" name="create_zh_introduction">
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="create_en_introduction">@lang('default.en_introduction'):</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="create_en_introduction" name="create_en_introduction">
                                </div>
                            </div>
                            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                            <div class="form-group">
